...
class Search extends Component {
    ...
    onChange=(e)=>{
        this.setState({[e.target.name]: e.target.value}) //e.target.name refers to all the names of the inputs, ie trackTitle: e.target.value 
    }

    findTrack=(dispatch, e)=>{
        e.preventDefault();
        //returns 10 tracks when searched
        ...
        .then(res => 
            {
                ...
                this.setState({trackTitle: ''}) //reset the search bar
            })
